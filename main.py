...
if args.mode == 'train':
    Model_d, Model_g = anogan.train(8, X_train)
...
##test_img = np.random.uniform(-1,1, (120,120,1))
...
##
##random_image = np.random.uniform(0, 1, (100, 120, 120, 3))
##print("random noise image")
##plt.figure(4, figsize=(2, 2))
##plt.title('random noise image')
##plt.imshow(random_image[0].reshape(120,120,3), cmap=plt.cm.gray)
##
### intermidieate output of discriminator
##model = anogan.feature_extractor()
##feature_map_of_random = model.predict(random_image, verbose=1)
##feature_map_of_minist = model.predict(X_test[:13], verbose=1)
##feature_map_of_minist_1 = model.predict(X_test[:13], verbose=1)
##
